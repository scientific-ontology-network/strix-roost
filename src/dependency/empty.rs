...
use horned_owl::model::{AnnotatedComponent, Build, Class, ClassExpression, Component, ForIRI, MutableOntology, SubClassOf};
...
use crate::dependency::base::reduce_map;

pub struct EmptinessDependency {}


impl<T:ForIRI> DependencyBuilder<T> for EmptinessDependency {
