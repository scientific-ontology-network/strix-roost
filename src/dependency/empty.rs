use horned_owl::model::{AnnotatedComponent, AsymmetricObjectProperty, ClassAssertion, ClassExpression, DataProperty, DataRange, DifferentIndividuals, DisjointObjectProperties, DisjointUnion, ForIRI, FunctionalObjectProperty, Individual, InverseFunctionalObjectProperty, IrreflexiveObjectProperty, Literal, NegativeObjectPropertyAssertion, ObjectPropertyAssertion, ObjectPropertyDomain, ObjectPropertyExpression, ObjectPropertyRange, ReflexiveObjectProperty, SameIndividual, SymmetricObjectProperty, TransitiveObjectProperty};
