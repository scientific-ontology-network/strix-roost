...
pub fn compute_semantic_dependency<'a,T:ForIRI + 'a>(ontology_iter: impl Iterator<Item = &'a AnnotatedComponent<T>>, extra_axiom_builder: fn(T) -> Rc<Axiom>) -> DependencyMap<T, HashSet<&'a Component<T>>>{
