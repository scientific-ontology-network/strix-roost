...
impl Runnable<()> for Print {
    fn run(&self) {
        ...
        let dependencies = reduce_map::<ArcStr, OntologySymbol<ArcStr>, DependencySymbolWithAxioms<OntologySymbol<ArcStr>, &Component<ArcStr>>>(&GrowthDependency::build_dependencies(set_index.iter()));
